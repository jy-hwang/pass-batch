...
(
  ...
  `ended_at`        datetime             DEFAULT NULL COMMENT '종료 일시, NULL인 경우 무제한',
  `expired_at`      datetime             DEFAULT NULL COMMENT '만료 일시',
  `created_at`      timestamp   NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성 일시',
  `modified_at`     datetime             DEFAULT NULL COMMENT '수정 일시',
...
(
  ...
  `started_at`   datetime    NOT NULL COMMENT '시작 일시',
  `ended_at`     datetime    NOT NULL COMMENT '종료 일시',
...
(
  ...
  `sent_at`          datetime               DEFAULT NULL COMMENT '발송 일시',
  `created_at`       timestamp     NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성 일시',
  `modified_at`      datetime               DEFAULT NULL COMMENT '수정 일시',
...
(
  ...
  `statistics_at`       datetime  NOT NULL COMMENT '통계 일시',
